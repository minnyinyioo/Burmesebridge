...
export const hsk1VocabularyMy: Record<string, VocabularyEnrichment> = {
  ...
  "儿子": { meaningMy: "သား" }, "二": { meaningMy: "နှစ်" }, "饭馆": { meaningMy: "စားသောက်ဆိုင်" }, "飞机": { meaningMy: "လေယာဉ်" },
  "分钟": { meaningMy: "မိနစ်" }, "高兴": { meaningMy: "ဝမ်းသာသော၊ ပျော်ရွှင်သော" }, "个": { meaningMy: "အထွေထွေသုံး ရေတွက်ပုဒ်" },
  "工作": { meaningMy: "အလုပ်လုပ်သည်၊ အလုပ်", image: "/images/hsk/vocabulary/hsk1-gongzuo-work.png", imageAltMy: "ကွန်ပျူတာဖြင့် အလုပ်လုပ်နေသော BurmeseBridge လေ့လာရေးလမ်းညွှန်", imageStatus: "generated" }, "狗": { meaningMy: "ခွေး" }, "汉语": { meaningMy: "တရုတ်ဘာသာစကား" }, "好": { meaningMy: "ကောင်းသော၊ ကောင်းသည်" },
  ...
  "块": { meaningMy: "အတုံး/အပိုင်း ရေတွက်ပုဒ်၊ ယွမ်၏ အရပ်သုံးအခေါ်" }, "来": { meaningMy: "လာသည်" }, "老师": { meaningMy: "ဆရာ၊ ဆရာမ" },
  ...
  "吗": { meaningMy: "ဟုတ်/မဟုတ် မေးခွန်းဖွဲ့ရာတွင် သုံးသော ပုဒ်" }, "买": { meaningMy: "ဝယ်သည်" }, "猫": { meaningMy: "ကြောင်" },
  "没": { meaningMy: "မရှိ၊ မ…ခဲ့ဘူး" }, "没关系": { meaningMy: "ကိစ္စမရှိပါဘူး၊ ရပါတယ်" }, "米饭": { meaningMy: "ချက်ပြီးသော ထမင်း" },
  ...
  "漂亮": { meaningMy: "လှပသော" }, "苹果": { meaningMy: "ပန်းသီး" }, "七": { meaningMy: "ခုနစ်" }, "钱": { meaningMy: "ငွေ" },
  ...
  "谢谢": { meaningMy: "ကျေးဇူးတင်သည်၊ ကျေးဇူးတင်ပါတယ်" }, "星期": { meaningMy: "သီတင်းပတ်၊ အပတ်" }, "学生": { meaningMy: "ကျောင်းသား၊ ကျောင်းသူ" },
  "学习": { meaningMy: "လေ့လာသင်ယူသည်" }, "学校": { meaningMy: "ကျောင်း" }, "一": { meaningMy: "တစ်" }, "衣服": { meaningMy: "အဝတ်အစား" },
  "医生": { meaningMy: "ဆရာဝန်" }, "医院": { meaningMy: "ဆေးရုံ" }, "椅子": { meaningMy: "ကုလားထိုင်" }, "有": { meaningMy: "ရှိသည်၊ ပိုင်ဆိုင်သည်" },
