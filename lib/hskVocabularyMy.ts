...
export const hsk1VocabularyMy: Record<string, VocabularyEnrichment> = {
  ...
  "时候": { meaningMy: "အချိန်၊ အခါ" }, "是": { meaningMy: "ဖြစ်သည်၊ ဟုတ်သည်" }, "书": { meaningMy: "စာအုပ်", image: "/images/hsk/vocabulary/hsk1-shu-book.png", imageAltMy: "ဖွင့်ထားသော စာအုပ်တစ်အုပ်ကို ဖတ်ရှု၍ စာမျက်နှာကို ညွှန်ပြနေသော BurmeseBridge လေ့လာရေးလမ်းညွှန်", imageStatus: "generated" }, "水": { meaningMy: "ရေ" },
  "水果": { meaningMy: "သစ်သီး", image: "/images/hsk/vocabulary/hsk1-shuiguo-fruit.png", imageAltMy: "ပန်းသီး၊ ငှက်ပျောသီး၊ လိမ္မော်သီးနှင့် စပျစ်သီးပါသော သစ်သီးခြင်းကို ပြသနေသော BurmeseBridge လေ့လာရေးလမ်းညွှန်", imageStatus: "generated" }, "睡觉": { meaningMy: "အိပ်သည်" }, "说话": { meaningMy: "စကားပြောသည်" }, "四": { meaningMy: "လေး" },
