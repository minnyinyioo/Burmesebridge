...
export const hsk1VocabularyMy: Record<string, VocabularyEnrichment> = {
  ...
  "工作": { meaningMy: "အလုပ်လုပ်သည်၊ အလုပ်" }, "狗": { meaningMy: "ခွေး" }, "汉语": { meaningMy: "တရုတ်ဘာသာစကား" }, "好": { meaningMy: "ကောင်းသော၊ ကောင်းသည်" },
  "喝": { meaningMy: "သောက်သည်" }, "和": { meaningMy: "နှင့်၊ ပြီးတော့" }, "很": { meaningMy: "အလွန်၊ တော်တော်" }, "后面": { meaningMy: "နောက်ဘက်၊ အနောက်ဘက်" },
