...
export default function CourseCheckout({locale,productId,userId,price,currency,requestStatus,onSubmitted}:Props) {
  ...
  const purchaseTerms = locale === "zh" ? ["购买前请核对课程或会员名称、价格、币种、访问期限、付款方式和收款账户。", "课程、会员和资料仅供购买者本人学习使用，不得转售、转租、共享账号、录屏分发或绕过访问控制。", "课程或会员开通、下载、观看、使用或获得访问权限后，原则上不因个人改变主意、误选课程、时间安排变化、未阅读课程说明或学习效果预期不同而退款。", "可申请退款或复核的常见情形包括重复扣款、未经授权交易、付款成功但平台未能开通服务、平台无法继续提供已购买核心服务、适用法律或支付渠道规则要求退款。", "实体卡、NFC 卡或定制材料一旦进入制作、个性化写入、寄送或第三方处理流程，通常不支持因个人原因退款。", "付款凭证仅用于审核；不要上传与付款无关的身份证件或敏感信息。发现问题请尽快联系平台并保留凭证，普通退款请求建议在付款后 7 天内提出。", "提交购买申请表示你已阅读、理解并同意购买规则、退款政策和服务条款；不同意不能继续。"] : locale === "my" ? ["မဝယ်ယူမီ သင်တန်း/အဖွဲ့ဝင်အစီအစဉ်၊ စျေးနှုန်း၊ ငွေကြေးအမျိုးအစား၊ အသုံးပြုခွင့်ကာလနှင့် ငွေလက်ခံမည့်အကောင့်ကို စစ်ဆေးပါ။", "သင်တန်း၊ membership နှင့် ပစ္စည်းများကို ဝယ်ယူသူကိုယ်တိုင် သင်ယူရန်သာ သုံးရမည်။ ပြန်ရောင်းခြင်း၊ ငှားခြင်း၊ account မျှဝေခြင်း၊ screen-recording ဖြန့်ဝေခြင်း သို့မဟုတ် ခွင့်ပြုချက်ကျော်လွှားခြင်း မပြုရ။", "သင်တန်း/အဖွဲ့ဝင်အသုံးပြုခွင့် ဖွင့်ပြီး၊ download၊ ကြည့်ရှု သို့မဟုတ် အသုံးပြုပြီးနောက် ကိုယ်ပိုင်စိတ်ပြောင်းခြင်း၊ course မှားရွေးခြင်း၊ အချိန်မရှိခြင်း သို့မဟုတ် မျှော်လင့်ချက်မတူခြင်းအတွက် refund မပေးနိုင်ပါ။", "ငွေထပ်ကောက်ခံမှု၊ ခွင့်မပြုထားသော payment၊ ငွေပေးပြီး service မဖွင့်ပေးနိုင်ခြင်း၊ platform က core service ဆက်မပေးနိုင်ခြင်း သို့မဟုတ် law/payment channel စည်းမျဉ်းအရ refund လိုအပ်ခြင်းများတွင် manual review တောင်းနိုင်ပါသည်။", "Physical card၊ NFC card သို့မဟုတ် custom material ကို ထုတ်လုပ်/ရေးသွင်း/ပို့ဆောင်/third-party process စတင်ပြီးပါက ကိုယ်ပိုင်အကြောင်းပြချက်ဖြင့် refund မရနိုင်ပါ။", "ငွေပေးချေမှုအထောက်အထားကို စိစစ်ရန်သာ သုံးမည်။ မလိုအပ်သော မှတ်ပုံတင် သို့မဟုတ် အရေးကြီးကိုယ်ရေးအချက်အလက် မတင်ပါနှင့်။ ပြဿနာရှိပါက platform သို့ အမြန်ဆက်သွယ်ပြီး အထောက်အထား သိမ်းထားပါ။ ပုံမှန် refund request ကို payment ပြီး ၇ ရက်အတွင်း တင်ရန် အကြံပြုပါသည်။", "ဝယ်ယူမှုတင်ပြခြင်းသည် purchase rules၊ refund policy နှင့် terms ကို ဖတ်ရှုနားလည်ပြီး သဘောတူခြင်း ဖြစ်သည်။ မသဘောတူပါက ဆက်လက်မလုပ်နိုင်ပါ။"] : ["Before buying, verify the course or membership name, price, currency, access period, payment method, and recipient account.", "Courses, memberships, and materials are for the purchaser’s personal learning only. Do not resell, rent, share accounts, record and distribute, or bypass access controls.", "After activation, download, viewing, use, or access grant, change-of-mind refunds are generally unavailable, including wrong course selection, schedule changes, not reading the description, or different expectations about learning outcomes.", "Refunds or manual review may be requested for duplicate charging, unauthorised transactions, payment without access, inability to provide the purchased core service, or where applicable law or payment-channel rules require it.", "Physical cards, NFC cards, and customised materials are usually not refundable for personal reasons once production, personalisation, shipping, or third-party processing has started.", "Payment proof is used only for review. Do not upload unrelated identity documents or sensitive information. Contact the platform promptly and keep your receipt if there is a problem. Ordinary refund requests should be submitted within 7 days after payment.", "Submitting a purchase request means you have read, understood, and agreed to the purchase rules, Refund Policy, and Terms. You cannot continue if you disagree."];
  ...
  const termsVersion = "purchase-refund-2026-09-05";
