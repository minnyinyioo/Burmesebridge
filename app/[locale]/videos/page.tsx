...
export default function VideosPage() {
  ...
  const copy = locale === "zh" ? { title: "视频课堂", intro: "免费、稳定的视频学习内容。", empty: "暂时还没有视频。", featured: "精选" } : locale === "my" ? { title: "ဗီဒီယို သင်ခန်းစာ", intro: "အခမဲ့နှင့် တည်ငြိမ်သော ဗီဒီယို သင်ယူမှုများ။", empty: "ဗီဒီယို မရှိသေးပါ။", featured: "ရွေးချယ်ထားသည်" } : { title: "Video learning", intro: "Free, reliable video lessons and community resources.", empty: "No videos published yet.", featured: "Featured" };
