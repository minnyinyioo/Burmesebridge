...
export default function ContentDetailPage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      const { data } = await supabase.from("news").select("id, category, pinned, featured, hot, title_my, title_zh, title_en, content_my, content_zh, content_en, created_at, media_blocks").eq("id", id).eq("status", "published").maybeSingle();
