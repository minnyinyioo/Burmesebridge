...
export default function RegisterPage() {
  ...
  const copy = locale === "zh" ? {
    ...
    title: "အကောင့်ဖွင့်ရန်", intro: "BurmeseBridge ထွင် သင်ယူရန်။ ဆက်သွယရန်။၊ အခွင့်အလမ်များ ရှာရန်။", name: "ပြသမှည့်အမှည်", email: "အီးမေးလ်", password: "စကားဝှက် (အနည်းဆုံး ၈ လုံး)", confirm: "စကားဝှက် အတည်ပြုပ်ရန်", button: "အကောင့်ဖွင့်မှန်", loading: "ဖန်တီးနေသည်…", login: "အကောင့်ဖန်ပြီးသါးလါ? ဝင်ရန်", mismatch: "စကားဝှက်နှစ်ခု မတူပါ။", short: "စကားဝှက်သည် အနည်းဆုံး ၈ လုံး ဖရမှန်။", required: "အမှည်၊ အီးမေးလ်နှင့်း စကားဝှက်ကို ပြည့်စုံစွား ဖြည့်ပါ။", sentTitle: "အီးမေးလ်ကို စစ်ဂျေးပါ", sent: "အတည်ပြုပ်လင့်ခ် ပို့ဒားပါသည်။ အီးမေးလ်အတည်ပြုပ်ပြီးနောက် ဝင်နိုင်ပါသည်။ Spam ဖိုလ်ဒါကိုလည် စစ်ဂျေးပါ။", back: "အကောင့်ဝင်ရန်", smtp: "အတည်ပြုပ် email ပို့နှို့မရပါ။ Brevo SMTP setting ကို စစ်ပါ။", rate: "Email တောင်းဆုိမှုများလွန်းပါသည်။ နောက်မှ ထပ်စမ်းပါ။", exists: "၉ email ဖြင့် account ဖန်ပြီးသါးပါ။", generic: "လောလောဆယ် အကောင့်ဖွင့်နှို့မရပါ။",
  } : {
