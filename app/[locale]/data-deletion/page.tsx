...
const content: Record<string, { title: string; summary: string; updated: string; sections: LegalSection[] }> = {
  zh: { title: "用户数据删除说明", summary: "你可以请求删除 BurmeseBridge 账号以及与账号关联的个人数据。", updated: "2026年8月15日", sections: [
    { title: "如何申请删除", paragraphs: [`使用注册账号的邮箱发送邮件至 ${CONTACT_EMAILS.privacy}，主题填写“删除 BurmeseBridge 账号”。邮件中请写明注册邮箱、显示名称以及使用的登录方式（邮箱、Google、GitHub 或 Facebook）。`] },
  ...
  my: { title: "အသုံးပြုသူဒေတာ ဖျက်ရန်", summary: "BurmeseBridge အကောင့်နှင့် ဆက်စပ်ကိုယ်ရေးအချက်အလက်များကို ဖျက်ရန် တောင်းဆိုနိုင်ပါသည်။", updated: "၂၀၂၆ ဩဂုတ် ၁၅", sections: [
    { title: "ဖျက်သိမ်းရန် တောင်းဆိုနည်း", paragraphs: [`အကောင့်ဖွင့်ရာတွင် အသုံးပြုထားသော အီးမေးလ်လိပ်စာမှ ${CONTACT_EMAILS.privacy} သို့ “Delete BurmeseBridge account” ဟူသော အကြောင်းအရာခေါင်းစဉ်ဖြင့် ပေးပို့ပါ။ မှတ်ပုံတင်ထားသော အီးမေးလ်လိပ်စာ၊ ဖော်ပြမည့်အမည်နှင့် အကောင့်ဝင်ရောက်သည့်နည်းလမ်းတို့ကို ထည့်သွင်းဖော်ပြပါ။`] },
  ...
  en: { title: "User Data Deletion", summary: "You may request deletion of your BurmeseBridge account and associated personal data.", updated: "August 15, 2026", sections: [
    { title: "How to request deletion", paragraphs: [`Email ${CONTACT_EMAILS.privacy} from the address registered to your account with the subject “Delete BurmeseBridge account.” Include the registered email, display name, and sign-in method (email, Google, GitHub, or Facebook).`] },
