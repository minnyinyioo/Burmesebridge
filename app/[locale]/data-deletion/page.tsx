...
const content: Record<string, { title: string; summary: string; updated: string; sections: LegalSection[] }> = {
  zh: { title: "用户数据删除说明", summary: "你可以请求删除 BurmeseBridge 账号以及与账号关联的个人数据。", updated: "2026年8月15日", sections: [
    { title: "如何申请删除", paragraphs: ["使用注册账号的邮箱发送邮件至 minnyinyioo6161@gmail.com，主题填写“删除 BurmeseBridge 账号”。邮件中请写明注册邮箱、显示名称以及使用的登录方式（邮箱、Google、GitHub 或 Facebook）。"] },
  ...
  my: { title: "အသုံးပြုသူဒေတာ ဖျက်ရန်", summary: "BurmeseBridge အကောင့်နှင့် ဆက်စပ်ကိုယ်ရေးအချက်အလက်များကို ဖျက်ရန် တောင်းဆိုနိုင်ပါသည်။", updated: "၂၀၂၆ ဩဂုတ် ၁၅", sections: [
    { title: "တောင်းဆိုနည်း", paragraphs: ["မှတ်ပုံတင်ထားသော အီးမေးလ်မှ minnyinyioo6161@gmail.com သို့ “Delete BurmeseBridge account” ခေါင်းစဉ်ဖြင့် ပို့ပါ။ အကောင့်အီးမေးလ်၊ ပြသအမည်နှင့် login နည်းလမ်းကို ထည့်ရေးပါ။"] },
  ...
  en: { title: "User Data Deletion", summary: "You may request deletion of your BurmeseBridge account and associated personal data.", updated: "August 15, 2026", sections: [
    { title: "How to request deletion", paragraphs: ["Email minnyinyioo6161@gmail.com from the address registered to your account with the subject “Delete BurmeseBridge account.” Include the registered email, display name, and sign-in method (email, Google, GitHub, or Facebook)."] },
