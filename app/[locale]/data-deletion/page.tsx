...
const content: Record<string, { title: string; summary: string; updated: string; sections: LegalSection[] }> = {
  zh: { title: "用户数据删除说明", summary: "你可以请求删除 BurmeseBridge 账号以及与账号关联的个人数据。", updated: "2026年8月15日", sections: [
    { title: "如何申请删除", paragraphs: ["使用注册账号的邮箱发送邮件至 admin@burmesebridge.eu.cc，主题填写“删除 BurmeseBridge 账号”。邮件中请写明注册邮箱、显示名称以及使用的登录方式（邮箱、Google、GitHub 或 Facebook）。"] },
    ...
    { title: "Facebook 数据删除", paragraphs: ["如果你使用 Facebook 登录，也可以在 Facebook 的“设置与隐私 → 设置 → 应用和网站”中移除 BurmeseBridge，然后按照本页步骤联系我们删除平台端数据。删除 BurmeseBridge 数据不会删除你的 Facebook 账号；完成删除后，Facebook 登录关联、Facebook 用户标识和平台保存的相关个人资料将被删除或匿名化。"] },
    { title: "处理时间", paragraphs: ["我们通常会在验证完成后30天内处理请求；复杂请求或法律要求可能需要更长时间，我们会通过邮件说明进度。"] },
  ] },
  my: { title: "အသုံးပြုသူဒေတာ ဖျက်ရန်", summary: "BurmeseBridge အကောင့်နှင့် ဆက်စပ်ကိုယ်ရေးအချက်အလက်များကို ဖျက်ရန် တောင်းဆိုနိုင်ပါသည်။", updated: "၂၀၂၆ ဩဂုတ် ၁၅", sections: [
    { title: "ဖျက်သိမ်းရန် တောင်းဆိုနည်း", paragraphs: ["အကောင့်ဖွင့်ရာတွင် အသုံးပြုထားသော အီးမေးလ်လိပ်စာမှ admin@burmesebridge.eu.cc သို့ “Delete BurmeseBridge account” ဟူသော အကြောင်းအရာခေါင်းစဉ်ဖြင့် ပေးပို့ပါ။ မှတ်ပုံတင်ထားသော အီးမေးလ်လိပ်စာ၊ ဖော်ပြမည့်အမည်နှင့် အကောင့်ဝင်ရောက်သည့်နည်းလမ်းတို့ကို ထည့်သွင်းဖော်ပြပါ။"] },
    ...
    { title: "Facebook ဒေတာ", paragraphs: ["Facebook Settings & privacy → Settings → Apps and websites တွင် BurmeseBridge ကို ဖယ်ရှားနိုင်ပြီး ထို့နောက် ဤစာမျက်နှာပါ အဆင့်အတိုင်း platform ဒေတာဖျက်ရန် ဆက်သွယ်ပါ။ BurmeseBridge ဒေတာဖျက်ခြင်းသည် Facebook account ကို မဖျက်ပါ။ ပြီးဆုံးပါက Facebook login ချိတ်ဆက်မှု၊ Facebook user ID နှင့် platform တွင်သိမ်းထားသော ဆက်စပ် profile ကို ဖျက် သို့မဟုတ် အမည်မသိအဖြစ် ပြောင်းပါမည်။"] },
  ...
  en: { title: "User Data Deletion", summary: "You may request deletion of your BurmeseBridge account and associated personal data.", updated: "August 15, 2026", sections: [
    { title: "How to request deletion", paragraphs: ["Email admin@burmesebridge.eu.cc from the address registered to your account with the subject “Delete BurmeseBridge account.” Include the registered email, display name, and sign-in method (email, Google, GitHub, or Facebook)."] },
    ...
    { title: "Facebook data deletion", paragraphs: ["If you used Facebook Login, you can also remove BurmeseBridge under Facebook Settings & privacy → Settings → Apps and websites, then contact us using the steps above to delete platform-side data. Deleting BurmeseBridge data does not delete your Facebook account. After completion, the Facebook Login association, Facebook user identifier, and related profile information stored by the platform will be deleted or anonymized."] },
