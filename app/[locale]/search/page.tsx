...
import { BookOpen, BriefcaseBusiness, Clock3, GraduationCap, MessageCircle, Newspaper, PlaySquare, Search, Trash2 } from "lucide-react";
...
export default function SearchPage() {
  ...
  const filters: ("all" | ResultType)[] = ["all", "news", "jobs", "learn", "forum", "video", "knowledge"];
